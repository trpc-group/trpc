...
func (x *StringRules) GetAlphabets() bool {
	if x != nil {
		if x, ok := x.WellKnown.(*StringRules_Alphabets); ok {
			return x.Alphabets
		}
	}
	return false
...
func (x *StringRules) GetAlphanums() bool {
	if x != nil {
		if x, ok := x.WellKnown.(*StringRules_Alphanums); ok {
			return x.Alphanums
		}
	}
	return false
...
func (x *StringRules) GetLowercase() bool {
	if x != nil {
		if x, ok := x.WellKnown.(*StringRules_Lowercase); ok {
			return x.Lowercase
		}
	}
	return false
...
func (x *StringRules) GetTsecstr() bool {
	if x != nil {
		if x, ok := x.WellKnown.(*StringRules_Tsecstr); ok {
			return x.Tsecstr
		}
	}
	return false
...
const file_trpc_v2_validate_validate_proto_rawDesc = "" +
	"\n" +
	"\x1ftrpc/v2/validate/validate.proto\x12\x10trpc.v2.validate\x1a google/protobuf/descriptor.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf8\t\n" +
	"\n" +
	"FieldRules\x128\n" +
	"\amessage\x18\x11 \x01(\v2\x1e.trpc.v2.validate.MessageRulesR\amessage\x124\n" +
	"\x05float\x18\x01 \x01(\v2\x1c.trpc.v2.validate.FloatRulesH\x00R\x05float\x127\n" +
	"\x06double\x18\x02 \x01(\v2\x1d.trpc.v2.validate.DoubleRulesH\x00R\x06double\x124\n" +
	"\x05int32\x18\x03 \x01(\v2\x1c.trpc.v2.validate.Int32RulesH\x00R\x05int32\x124\n" +
	"\x05int64\x18\x04 \x01(\v2\x1c.trpc.v2.validate.Int64RulesH\x00R\x05int64\x127\n" +
	"\x06uint32\x18\x05 \x01(\v2\x1d.trpc.v2.validate.UInt32RulesH\x00R\x06uint32\x127\n" +
	"\x06uint64\x18\x06 \x01(\v2\x1d.trpc.v2.validate.UInt64RulesH\x00R\x06uint64\x127\n" +
	"\x06sint32\x18\a \x01(\v2\x1d.trpc.v2.validate.SInt32RulesH\x00R\x06sint32\x127\n" +
	"\x06sint64\x18\b \x01(\v2\x1d.trpc.v2.validate.SInt64RulesH\x00R\x06sint64\x12:\n" +
	"\afixed32\x18\t \x01(\v2\x1e.trpc.v2.validate.Fixed32RulesH\x00R\afixed32\x12:\n" +
	"\afixed64\x18\n" +
	" \x01(\v2\x1e.trpc.v2.validate.Fixed64RulesH\x00R\afixed64\x12=\n" +
	"\bsfixed32\x18\v \x01(\v2\x1f.trpc.v2.validate.SFixed32RulesH\x00R\bsfixed32\x12=\n" +
	"\bsfixed64\x18\f \x01(\v2\x1f.trpc.v2.validate.SFixed64RulesH\x00R\bsfixed64\x121\n" +
	"\x04bool\x18\r \x01(\v2\x1b.trpc.v2.validate.BoolRulesH\x00R\x04bool\x127\n" +
	"\x06string\x18\x0e \x01(\v2\x1d.trpc.v2.validate.StringRulesH\x00R\x06string\x124\n" +
	"\x05bytes\x18\x0f \x01(\v2\x1c.trpc.v2.validate.BytesRulesH\x00R\x05bytes\x121\n" +
	"\x04enum\x18\x10 \x01(\v2\x1b.trpc.v2.validate.EnumRulesH\x00R\x04enum\x12=\n" +
	"\brepeated\x18\x12 \x01(\v2\x1f.trpc.v2.validate.RepeatedRulesH\x00R\brepeated\x12.\n" +
	"\x03map\x18\x13 \x01(\v2\x1a.trpc.v2.validate.MapRulesH\x00R\x03map\x12.\n" +
	"\x03any\x18\x14 \x01(\v2\x1a.trpc.v2.validate.AnyRulesH\x00R\x03any\x12=\n" +
	"\bduration\x18\x15 \x01(\v2\x1f.trpc.v2.validate.DurationRulesH\x00R\bduration\x12@\n" +
	"\ttimestamp\x18\x16 \x01(\v2 .trpc.v2.validate.TimestampRulesH\x00R\ttimestampB\x06\n" +
	"\x04type\"\xb0\x01\n" +
	"\n" +
	"FloatRules\x12\x14\n" +
	...
	"\x06not_in\x18\a \x03(\x02R\x05notIn\x12!\n" +
	...
	"\x06not_in\x18\a \x03(\x01R\x05notIn\x12!\n" +
	"\fignore_empty\x18\b \x01(\bR\vignoreEmpty\"\xb0\x01\n" +
	"\n" +
	"Int32Rules\x12\x14\n" +
	...
	"\x06not_in\x18\a \x03(\x04R\x05notIn\x12!\n" +
	"\fignore_empty\x18\b \x01(\bR\vignoreEmpty\"\xb1\x01\n" +
	...
	"\x06not_in\x18\a \x03(\x11R\x05notIn\x12!\n" +
	"\fignore_empty\x18\b \x01(\bR\vignoreEmpty\"\xb1\x01\n" +
	...
	"\x06not_in\x18\a \x03(\x12R\x05notIn\x12!\n" +
	"\fignore_empty\x18\b \x01(\bR\vignoreEmpty\"\xb2\x01\n" +
	...
	"\x06not_in\x18\a \x03(\aR\x05notIn\x12!\n" +
	"\fignore_empty\x18\b \x01(\bR\vignoreEmpty\"\xb2\x01\n" +
	...
	"\x06not_in\x18\a \x03(\x06R\x05notIn\x12!\n" +
	"\fignore_empty\x18\b \x01(\bR\vignoreEmpty\"\xb3\x01\n" +
	...
	"\x06not_in\x18\a \x03(\x0fR\x05notIn\x12!\n" +
	"\fignore_empty\x18\b \x01(\bR\vignoreEmpty\"\xb3\x01\n" +
	...
	"\x06not_in\x18\a \x03(\x10R\x05notIn\x12!\n" +
	"\fignore_empty\x18\b \x01(\bR\vignoreEmpty\"!\n" +
	"\tBoolRules\x12\x14\n" +
	"\x05const\x18\x01 \x01(\bR\x05const\"\xd8\x06\n" +
	...
	"\bcontains\x18\t \x01(\tR\bcontains\x12!\n" +
	"\fnot_contains\x18\x17 \x01(\tR\vnotContains\x12\x0e\n" +
	"\x02in\x18\n" +
	" \x03(\tR\x02in\x12\x15\n" +
	...
	"\auri_ref\x18\x12 \x01(\bH\x00R\x06uriRef\x12\x1a\n" +
	"\aaddress\x18\x15 \x01(\bH\x00R\aaddress\x12\x14\n" +
	"\x04uuid\x18\x16 \x01(\bH\x00R\x04uuid\x12H\n" +
	"\x10well_known_regex\x18\x18 \x01(\x0e2\x1c.trpc.v2.validate.KnownRegexH\x00R\x0ewellKnownRegex\x12\x1e\n" +
	"\talphabets\x18\x1b \x01(\bH\x00R\talphabets\x12\x1e\n" +
	"\talphanums\x18\x1c \x01(\bH\x00R\talphanums\x12\x1e\n" +
	"\tlowercase\x18\x1d \x01(\bH\x00R\tlowercase\x12\x1a\n" +
	"\atsecstr\x18\x1e \x01(\bH\x00R\atsecstr\x12\x1c\n" +
	"\x06strict\x18\x19 \x01(\b:\x04trueR\x06strict\x12!\n" +
	"\fignore_empty\x18\x1a \x01(\bR\vignoreEmptyB\f\n" +
	"\n" +
	"well_known\"\xe2\x02\n" +
	"\n" +
	"BytesRules\x12\x14\n" +
	...
	"\x04ipv6\x18\f \x01(\bH\x00R\x04ipv6\x12!\n" +
	"\fignore_empty\x18\x0e \x01(\bR\vignoreEmptyB\f\n" +
	"\n" +
	"well_known\"k\n" +
	"\tEnumRules\x12\x14\n" +
	...
	"\brequired\x18\x02 \x01(\bR\brequired\"\xb8\x01\n" +
	"\rRepeatedRules\x12\x1b\n" +
	"\tmin_items\x18\x01 \x01(\x04R\bminItems\x12\x1b\n" +
	"\tmax_items\x18\x02 \x01(\x04R\bmaxItems\x12\x16\n" +
	"\x06unique\x18\x03 \x01(\bR\x06unique\x122\n" +
	"\x05items\x18\x04 \x01(\v2\x1c.trpc.v2.validate.FieldRulesR\x05items\x12!\n" +
	"\fignore_empty\x18\x05 \x01(\bR\vignoreEmpty\"\xec\x01\n" +
	"\bMapRules\x12\x1b\n" +
	"\tmin_pairs\x18\x01 \x01(\x04R\bminPairs\x12\x1b\n" +
	"\tmax_pairs\x18\x02 \x01(\x04R\bmaxPairs\x12\x1b\n" +
	"\tno_sparse\x18\x03 \x01(\bR\bnoSparse\x120\n" +
	"\x04keys\x18\x04 \x01(\v2\x1c.trpc.v2.validate.FieldRulesR\x04keys\x124\n" +
	"\x06values\x18\x05 \x01(\v2\x1c.trpc.v2.validate.FieldRulesR\x06values\x12!\n" +
	...
	"\bdisabled\x12\x1f.google.protobuf.MessageOptions\x18\x83\t \x01(\bR\bdisabled::\n" +
	"\aignored\x12\x1f.google.protobuf.MessageOptions\x18\x84\t \x01(\bR\aignored::\n" +
	"\brequired\x12\x1d.google.protobuf.OneofOptions\x18\x83\t \x01(\bR\brequired:R\n" +
	"\x05rules\x12\x1d.google.protobuf.FieldOptions\x18\x83\t \x01(\v2\x1c.trpc.v2.validate.FieldRulesR\x05rulesBU\n" +
	"\x1dcom.tencent.trpc.protobuf.extZ4trpc.group/trpc/trpc-protocol/pb/go/trpc/v2/validate"

var (
	file_trpc_v2_validate_validate_proto_rawDescOnce sync.Once
	file_trpc_v2_validate_validate_proto_rawDescData []byte
)

func file_trpc_v2_validate_validate_proto_rawDescGZIP() []byte {
	file_trpc_v2_validate_validate_proto_rawDescOnce.Do(func() {
		file_trpc_v2_validate_validate_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_trpc_v2_validate_validate_proto_rawDesc), len(file_trpc_v2_validate_validate_proto_rawDesc)))
	})
...
var file_trpc_v2_validate_validate_proto_goTypes = []any{
...
func file_trpc_v2_validate_validate_proto_init() {
	...
	file_trpc_v2_validate_validate_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_trpc_v2_validate_validate_proto_msgTypes[14].OneofWrappers = []any{
	...
	file_trpc_v2_validate_validate_proto_msgTypes[15].OneofWrappers = []any{
		(*BytesRules_Ip)(nil),
		(*BytesRules_Ipv4)(nil),
		(*BytesRules_Ipv6)(nil),
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_trpc_v2_validate_validate_proto_rawDesc), len(file_trpc_v2_validate_validate_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   23,
			NumExtensions: 4,
			NumServices:   0,
