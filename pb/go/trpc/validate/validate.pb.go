...
const file_trpc_validate_validate_proto_rawDesc = "" +
	"\n" +
	"\x1ctrpc/validate/validate.proto\x12\rtrpc.validate\x1a google/protobuf/descriptor.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb6\t\n" +
	"\n" +
	"FieldRules\x125\n" +
	"\amessage\x18\x11 \x01(\v2\x1b.trpc.validate.MessageRulesR\amessage\x121\n" +
	"\x05float\x18\x01 \x01(\v2\x19.trpc.validate.FloatRulesH\x00R\x05float\x124\n" +
	"\x06double\x18\x02 \x01(\v2\x1a.trpc.validate.DoubleRulesH\x00R\x06double\x121\n" +
	"\x05int32\x18\x03 \x01(\v2\x19.trpc.validate.Int32RulesH\x00R\x05int32\x121\n" +
	"\x05int64\x18\x04 \x01(\v2\x19.trpc.validate.Int64RulesH\x00R\x05int64\x124\n" +
	"\x06uint32\x18\x05 \x01(\v2\x1a.trpc.validate.UInt32RulesH\x00R\x06uint32\x124\n" +
	"\x06uint64\x18\x06 \x01(\v2\x1a.trpc.validate.UInt64RulesH\x00R\x06uint64\x124\n" +
	"\x06sint32\x18\a \x01(\v2\x1a.trpc.validate.SInt32RulesH\x00R\x06sint32\x124\n" +
	"\x06sint64\x18\b \x01(\v2\x1a.trpc.validate.SInt64RulesH\x00R\x06sint64\x127\n" +
	"\afixed32\x18\t \x01(\v2\x1b.trpc.validate.Fixed32RulesH\x00R\afixed32\x127\n" +
	"\afixed64\x18\n" +
	" \x01(\v2\x1b.trpc.validate.Fixed64RulesH\x00R\afixed64\x12:\n" +
	"\bsfixed32\x18\v \x01(\v2\x1c.trpc.validate.SFixed32RulesH\x00R\bsfixed32\x12:\n" +
	"\bsfixed64\x18\f \x01(\v2\x1c.trpc.validate.SFixed64RulesH\x00R\bsfixed64\x12.\n" +
	"\x04bool\x18\r \x01(\v2\x18.trpc.validate.BoolRulesH\x00R\x04bool\x124\n" +
	"\x06string\x18\x0e \x01(\v2\x1a.trpc.validate.StringRulesH\x00R\x06string\x121\n" +
	"\x05bytes\x18\x0f \x01(\v2\x19.trpc.validate.BytesRulesH\x00R\x05bytes\x12.\n" +
	"\x04enum\x18\x10 \x01(\v2\x18.trpc.validate.EnumRulesH\x00R\x04enum\x12:\n" +
	"\brepeated\x18\x12 \x01(\v2\x1c.trpc.validate.RepeatedRulesH\x00R\brepeated\x12+\n" +
	"\x03map\x18\x13 \x01(\v2\x17.trpc.validate.MapRulesH\x00R\x03map\x12+\n" +
	"\x03any\x18\x14 \x01(\v2\x17.trpc.validate.AnyRulesH\x00R\x03any\x12:\n" +
	"\bduration\x18\x15 \x01(\v2\x1c.trpc.validate.DurationRulesH\x00R\bduration\x12=\n" +
	"\ttimestamp\x18\x16 \x01(\v2\x1d.trpc.validate.TimestampRulesH\x00R\ttimestampB\x06\n" +
	"\x04type\"\xb0\x01\n" +
	"\n" +
	"FloatRules\x12\x14\n" +
	...
	"\tBoolRules\x12\x14\n" +
	"\x05const\x18\x01 \x01(\bR\x05const\"\xd5\x06\n" +
	...
	"\x04uuid\x18\x16 \x01(\bH\x00R\x04uuid\x12E\n" +
	"\x10well_known_regex\x18\x18 \x01(\x0e2\x19.trpc.validate.KnownRegexH\x00R\x0ewellKnownRegex\x12\x1e\n" +
	...
	"\brequired\x18\x02 \x01(\bR\brequired\"\xb5\x01\n" +
	...
	"\x05items\x18\x04 \x01(\v2\x19.trpc.validate.FieldRulesR\x05items\x12!\n" +
	"\fignore_empty\x18\x05 \x01(\bR\vignoreEmpty\"\xe6\x01\n" +
	"\bMapRules\x12\x1b\n" +
	...
	"\x04keys\x18\x04 \x01(\v2\x19.trpc.validate.FieldRulesR\x04keys\x121\n" +
	"\x06values\x18\x05 \x01(\v2\x19.trpc.validate.FieldRulesR\x06values\x12!\n" +
	...
	"\brequired\x12\x1d.google.protobuf.OneofOptions\x18\xaf\b \x01(\bR\brequired:O\n" +
	"\x05rules\x12\x1d.google.protobuf.FieldOptions\x18\xaf\b \x01(\v2\x19.trpc.validate.FieldRulesR\x05rulesBR\n" +
	"\x1dcom.tencent.trpc.protobuf.extZ1trpc.group/trpc/trpc-protocol/pb/go/trpc/validate"

var (
	file_trpc_validate_validate_proto_rawDescOnce sync.Once
	file_trpc_validate_validate_proto_rawDescData []byte
)

func file_trpc_validate_validate_proto_rawDescGZIP() []byte {
	file_trpc_validate_validate_proto_rawDescOnce.Do(func() {
		file_trpc_validate_validate_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_trpc_validate_validate_proto_rawDesc), len(file_trpc_validate_validate_proto_rawDesc)))
	})
...
var file_trpc_validate_validate_proto_goTypes = []any{
...
func file_trpc_validate_validate_proto_init() {
	...
	file_trpc_validate_validate_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_trpc_validate_validate_proto_msgTypes[14].OneofWrappers = []any{
	...
	file_trpc_validate_validate_proto_msgTypes[15].OneofWrappers = []any{
		(*BytesRules_Ip)(nil),
		(*BytesRules_Ipv4)(nil),
		(*BytesRules_Ipv6)(nil),
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_trpc_validate_validate_proto_rawDesc), len(file_trpc_validate_validate_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   23,
			NumExtensions: 4,
			NumServices:   0,
